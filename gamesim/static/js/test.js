...
//   mpld3_Axes.prototype.requiredProps = [ "xlim", "ylim" ];
  ...
  function mpld3_Axes(fig, props) {
    ...
    if (this.props.xscale === "date") {
      this.x = mpld3.multiscale(d3.scale.linear().domain(ppp.xlim).range(this.props.xdomain.map(Number)), this.xdom);
    ...
    if (this.props.yscale === "date") {
      this.x = mpld3.multiscale(d3.scale.linear().domain(ppp.ylim).range(this.props.ydomain.map(Number)), this.ydom);
